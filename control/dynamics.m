...
function xd = dynamics(x, u)   
    ...
    % Foot contact model
    if Pc1y > ground_height
        Fy1 = 0;
        Fx1 = 0;
    else
        Fy1 = (K_foot*(Pc1y - ground_height)^2)*exp(-b_foot*Vc1y);
        Fx1 = -mu_foot*Fy1*tanh(Vc1x/0.01);
    end
    ...
    if Pc2y > seat_height
        ...
        Fy2 = (K_hip*(Pc2y - seat_height)^2)*exp(-b_hip*Vc2y);
        Fx2 = -mu_hip*Fy2*tanh(Vc2x/0.01);
    end
